...
```{r}
# Determine whether random forests are equally predictive across race, age, and gender
...
# ---------------------------------------------------------NONVIOLENT-------------------------------------------------------------------
# Race
f2 <- Surv(start, end, event, type="counting") ~ race_factor + non_violent_score_factor + race_factor * score_factor
