...
The nonviolent LDA model has an accuracy of approximately 67%, whereas the violent LDA model has an accuracy of about 51%. The nonviolent QDA model has an accuracy of approximately 63%, whereas the violent QDA model has an accuracy of about 54%.
